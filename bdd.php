...
function creationTable() {
    ...
    $requeteSQLCreation = 'CREATE TABLE "annonce" (
...
function insertionDonneesExemple() {
    ...
    $requeteSQLInsertion = "INSERT INTO annonce (titre, description, categorie, pseudo, prix, photo, rdv_lat, rdv_lon) VALUES
...
function vidageTable() {
    ...
    $requeteSQLVidage = "DELETE FROM annonce";
    $pdo->query($requeteSQLVidage);
}

function lecture(){
    $pdo =connexion();
    $abc = "select * from annonce";
    $res = $pdo->query($abc);
